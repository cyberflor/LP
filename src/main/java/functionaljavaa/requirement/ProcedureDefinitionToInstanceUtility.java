...
public class ProcedureDefinitionToInstanceUtility {
    ...
    public static final Object[][] procedureAddSopToUsersByRole( String procName, Integer procVersion, String schemaName, String roleName, String sopName, Integer sopVersion, Integer sopRevision){
        ...
        Object[][] personPerRole = Rdbms.getRecordFieldsByFilter(schemaNameDestination, ProcedureDefinitionToInstance.TABLE_NAME_PERSON_PROFILE_DESTINATION,
        new String[]{ProcedureDefinitionToInstance.FLD_NAME_PERSON_PROFILE_ROLE_NAME}, new Object[]{roleName}, new String[]{ProcedureDefinitionToInstance.FLD_NAME_PERSON_PROFILE_PERSON_NAME}, null);
    ...
    public static final void procedureAddUserSops( String procName, Integer procVersion, String schemaName){
        ...
        Object[][] procUserReqInfo = Rdbms.getRecordFieldsByFilter(schemaName, ProcedureDefinitionToInstance.TABLE_NAME_SOP_META_DATA_DESTINATION, 
