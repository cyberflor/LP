...
import static functionalJava.sampleStructure.DataSample.FIELDNAME_ANALYSIS;
import static functionalJava.sampleStructure.DataSample.FIELDNAME_CODE;
import static functionalJava.sampleStructure.DataSample.FIELDNAME_VARIATION_NAME;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Integer iLines=numHeaderLines;iLines<totalLines;iLines++){
                ...
                if ( (LPPlatform.LAB_FALSE.equalsIgnoreCase(specLimits[0][0].toString())) && (!"Rdbms_NoRecordsFound".equalsIgnoreCase(specLimits[0][4].toString())) ){
                    ...
                    //result = Float.parseFloat(ruleVariables.toString());
