    ...
    protected Response processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
                ...
                String usValido =  request.getAttribute("m_respuestaUsuarioValido").toString();
                String varSesion = mySession.getAttribute("dhue8y7d8ue8").toString();            
           out.println("UsValido="+usValido);
           out.println("var Sesion="+varSesion);
